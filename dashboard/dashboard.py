...
# Load cleaned data
hour_df = pd.read_csv("https://raw.githubusercontent.com/lusiaulia/Bike-Sharing/main/dashboard/Hour.csv")
day_df = pd.read_csv("https://raw.githubusercontent.com/lusiaulia/Bike-Sharing/main/dashboard/Day.csv")
...
with st.sidebar:
    ...
    st.image("https://raw.githubusercontent.com/lusiaulia/Bike-Sharing/main/dashboard/bbk.jpg")
...
st.image('https://raw.githubusercontent.com/lusiaulia/Bike-Sharing/21f68d601423545625691116c6d5a6678dba4027/dashboard/sosmed.png', width= 400, caption= 'Sosial Media, source : pngtree.com')
with st.expander("Lihat Penjelasan"):
    st.write(
    """
